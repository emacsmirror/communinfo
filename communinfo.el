...
(defconst communinfo
  '( (("3dldf") . "https://www.gnu.org/software/%m/manual/user_ref/%e")
     (("8sync" "alive" "anubis" "artanis" "autoconf" "autogen" "automake" "bash" "bison" "ccd2cue" "cflow" "chess" "combine" "complexity" "complexity" "coreutils" "cpio" "diffutils" "emacs-muse" "g-golf" "gama" "gawk" "gcal" "gettext" "gnubg" "gnubik" "gnulib" "gperf" "grep" "groff" "gsasl" "gsl" "gsrc" "gss" "guile" "guile" "guile-rpc" "gv" "gzip" "hello" "idutils" "inetutils" "libc" "libextractor" "libidn" "libmicrohttpd" "librejs" "libtasn1" "libtool" "lightning" "liquidwar6" "m4" "mailutils" "make" "mdk" "mes" "parted" "proxyknife" "pspp" "pyconfigure" "rcs" "recutils" "remotecontrol" "rottlog" "rottlog" "screen" "screen" "sed" "sharutils" "shepherd" "sourceinstall" "sqltutor" "tar" "teseq" "units" "vc-dwim" "wdiff" "wdiff" "websocket4j" "wget" "xboard" "xboard") . "https://www.gnu.org/software/%m/manual/html_node/%e")
     ...
     (("atk" "clutter" "clutter-glx" "corba" "gconf" "gdk" "glib" "gnome-vfs" "gobject" "gtk" "libglade" "libgnome" "libgnomecanvas" "libgnomeui" "pango" "pangocairo") . "https://www.gnu.org/software/guile-gnome/docs/%m/html/%e")
     (("auctex" "preview-latex") . "https://www.gnu.org/software/auctex/manual/%m/%e")
     ...
     (("cvs" "gnun" "web-trans") . "https://www.gnu.org/software/trans-coord/manual/%m/html_node/%e")
     (("dico" "rush") . "https://www.gnu.org.ua/software/%m/manual/html_node/%e")
     (("emacs-shroud") . "https://www.nongnu.org/emacs-shroud/manual/html_node/%e")
     (("emacsy") . "https://www.nongnu.org/emacsy/manual/html_node/%e")
     (("easejs" "emms" "gmediaserver" "gnu-crypto" "gnuprologjava" "motti" "recutils" "thales") . "https://www.gnu.org/software/%m/manual/%e")
     ...
     (("gawkinet" "gawkworkflow" "pm-gawk") . "https://www.gnu.org/software/gawk/manual/%m/html_node/%e")
     (("gdbm" "pies") . "http://www.gnu.org.ua/software/%m/manual/%e")
     ...
     (("gnu-arch") . "https://www.gnu.org/software/gnu-arch/tutorial/%e")
     ...
     (("gst") . "https://www.gnu.org/software/smalltalk/manual/html_node/%e")
     (("gst-base") . "https://www.gnu.org/software/smalltalk/manual-base/html_node/%e")
     (("gst-libs") . "https://www.gnu.org/software/smalltalk/manual-libs/html_node/%e")
     (("guile-algorithms") . "https://guile-algorithms.lajszczak.dev/%e")
     (("guile-email") . "https://guile-email.systemreboot.net/manual/dev/en/%e")
     (("guile-gtk") . "https://www.gnu.org/software/guile-gtk/docs/%m/%e")
     ...
     (("info-stnd" "texi2any_api" "texinfo") . "https://www.gnu.org/software/texinfo/manual/%m/html_node/%e")
     (("lepton-manual" "lepton-scheme") . "https://lepton-eda.github.io/%m.html/%e")
     (("libc") . "https://sourceware.org/glibc/manual/latest/html_node/%e")
     (("libidn2") . "https://www.gnu.org/software/libidn/libidn2/manual/html_node/%e")
     ...
     (("plotutils") . "https://www.gnu.org/software/%m/manual/en/html_node/%e")
