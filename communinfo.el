...
;; of Emacs.  This package provides the variable `communinfo' which
;; can be used as value for `Info-url-alist' that provides
;; URL-associations for many more free, libre and open source software
;; projects.
