...
(defconst communinfo
  '( (("3dldf") . "https://gnu.org/s/%m/manual/user_ref/%e")
     ...
     (("dico" "rush") . "https://gnu.org.ua/software/%m/manual/html_node/%e")
     (("emacs-shroud") . "https://nongnu.org/emacs-shroud/manual/html_node/%e")
     (("emacsy") . "https://nongnu.org/emacsy/manual/html_node/%e")
     (("easejs" "emms" "gmediaserver" "gnu-crypto" "gnuprologjava" "motti" "recutils" "thales") . "https://gnu.org/s/%m/manual/%e")
     ...
     (("gdbm" "pies") . "http://gnu.org.ua/software/%m/manual/%e")
     ...
     (("groff") . "https://gnu.org/s/%m/manual/%m.html.node/%e")
     ...
     (("pspp") . "https://gnu.org/s/pspp/manual/html_node/%e")
     (("pspp-dev") . "https://gnu.org/s/pspp/pspp-dev/html_node/%e")
     (("recutils") . "https://gnu.org/s/%m/manual/%e")
